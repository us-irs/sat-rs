...
//! packets. Call [SingleSetHkHelperStd::needs_generation] periodically, for example once per task
...
//!
//! - [SingleSetHkHelperStd]: `std::time::Instant`, behind the `std` feature.
//! - [SingleSetHkHelperEmbassy]: `embassy_time::Instant`, behind the `embassy-time` feature.
//! - [SingleSetHkHelperCountdown]: any clock implementing [Countdown], for example a
